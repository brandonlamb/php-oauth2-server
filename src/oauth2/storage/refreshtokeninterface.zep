...
interface RefreshTokenInterface extends StorageInterface
{
     ...
     * @ingroup oauth2_section_6
     */
    public function setRefreshToken(string! refresh_token, string! client_id, string! user_id, int expires, string! scope = null) -> void;
     ...
     * @ingroup oauth2_section_6
     */
    public function unsetRefreshToken(string! refresh_token) -> void;
}
