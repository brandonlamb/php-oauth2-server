...
interface ClientInterface extends StorageInterface
{
     ...
     */
    public function getClientDetails(string! client_id) -> array;
     ...
     */
    public function getClientScope(string! client_id) -> string;
     ...
     * @ingroup oauth2_section_4
     */
    public function checkRestrictedGrantType(string! client_id, string! grant_type) -> boolean;
}
