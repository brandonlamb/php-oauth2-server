...
interface AuthorizationCodeInterface extends StorageInterface
{
    /**
     ...
     * @ingroup oauth2_section_4
     */
    public function setAuthorizationCode(string! code, string! client_id, string! user_id, string! redirect_uri, int expires, string! scope = null) -> void;
     ...
     *
     */
    public function expireAuthorizationCode(string! code) -> void;
}
